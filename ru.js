...
export const ru = {
  translation: {
    ...
    back_up_your_wallet_description: "Сохраните свой кошелек в облаке и защитите его паролем. Вы также можете записать свою сид-фразу или скопировать ее в менеджер паролей.", // Save your wallet to the cloud and protect it with a password. You can also write down your Seed Phrase or copy it to a password manager.
    pin_description: "Если вы забудете свой PIN-код, вам придется восстановить кошелек из резервной копии.", // If your forget your PIN, you will need to restore your wallet from a backup.
    change_pin: "Изменить PIN-код", // Change PIN
    your_pin_is_required: "Ваш PIN-код необходим для совершения платежей и выполнения важных действий.", // Your PIN is required to make payments and perform sensitive actions.
    use_fingerprint: "Использовать отпечаток пальца/Face ID", // Use Fingerprint/Face ID
    ask_every_time_i_open_the_app: "Спрашивать каждый раз при открытии приложения", // Ask every time I open the app
    this_will_remove_all_wallet: "Это удалит все данные кошелька с вашего устройства.", // This will remove all wallet related data from your device.
    delete_wallet: "Удалить кошелек", // Delete Wallet
    sign_in_to_the_dogeverse: "Войти в Dogeverse", // Sign in to the Dogeverse
    dogeverse_intro_description: "Получите свой DogeTag, найдите друзей, получайте платежи по своей ссылке и взаимодействуйте с контентом в Dogeverse.", // Claim Your DogeTag, find friends, receive payments with your link, and engage with content in the Dogeverse.
    sign_in: "Войти", // Sign in
    sign_in_description: "Ваш номер телефона используется только для входа и не будет опубликован.", // Your phone number is only used to sign in and will not be made public.
    create_account_description: "Присоединяйтесь к Dogeverse и подключайтесь к огромной сети Шибов.", // Join the Dogeverse and connect with a huge network of Shibes.
    ...
    youre_now_ready_to_explore_the_dogeverse: "Теперь вы готовы исследовать Dogeverse!", // You're now ready to explore the Dogeverse!
    ...
    show_wallet_address_and_tip_button: "Показывать адрес кошелька и кнопку чаевых", // Show wallet address and Tip button
    ...
    send_doge_alert_box_message: "Вы можете отправить DOGE своим друзьям, введите адрес кошелька или имя пользователя MyDoge", // You can send DOGE to your friends, enter a wallet address or a MyDoge username
    ...
    max_tx_size_warning: "ВНИМАНИЕ: Достигнут максимальный размер транзакции. Это максимальная сумма, которую вы можете отправить за раз.", // WARNING: Max transaction size reached. This is the most you can send at once.
    confirm_transaction_warning: "Всегда проверяйте, кому вы отправляете, перед подтверждением. Никогда не отправляйте на адрес вывода биржи. Транзакции Dogecoin нельзя отменить!", // Always double check who you are sending to before confirming. Never send to an exchange withdrawal address. Dogecoin transactions can not be reversed!
    ...
    enter_new_PIN_description: "Введите новый PIN-код для вашего кошелька MyDoge", // Enter your new PIN for your MyDoge wallet
    ...
    biometrics_confirmation: "Хотите использовать биометрию для разблокировки кошелька?", // Do you want to use biometrics to unlock your wallet?
    use_biometrics: "Использовать биометрию", // Use Biometrics
    dismiss: "Отклонить", // Dismiss
    remove_wallet_data_description: "Это удалит все данные, связанные с кошельком, с вашего устройства.", // This will remove all wallet related data from your device.
    ...
    remove_wallet_description: "Ваш текущий кошелек будет удален из этого приложения, однако он всегда будет существовать в блокчейне.", // Your current wallet will be removed from this app, however it will always exist on the blockchain.
    remove_profile_assets_description: "Ваш профиль пользователя и активы будут удалены навсегда. Это действие нельзя отменить.", // Your user profile and assets will be removed and deleted permanently. This action cannot be undone.
    wallet_recovery_description: "Вы можете восстановить этот кошелек ТОЛЬКО с помощью вашей", // You can ONLY recover this wallet with your
    ...
    save_seed_phrase_instructions: "Сохраните эти слова по порядку. Запишите их и храните в безопасном месте или скопируйте в менеджер паролей.", // Save these words, in order. Write them down and keep them somewhere safe, or copy them to a password manager.
    seed_phrase_warning: "Ваша сид-фраза - это ключ к вашему кошельку. Любой, у кого есть эта фраза, может получить доступ к вашим средствам. Нажмите, чтобы узнать больше", // Your Seed Phrase is the key to your wallet. Anyone with this phrase can access your funds. Tap to learn more
    copy: "Копировать", // Copy
    hide: "Скрыть", // Hide
    show: "Показать", // Show
    screenshot_detected: "Обнаружен скриншот", // Screenshot detected
    screenshot_warning: "Скриншоты или другие цифровые копии вашей сид-фразы могут попасть к третьим лицам.", // Screenshots or other digital copies of your seed phrase could leak to a third party.
    okay: "Хорошо", // Okay
    ...
    visit_mydogetv_twitch: "Посетите MyDogeTV на Twitch для получения дополнительной информации", // Visit MyDogeTV on Twitch for more info
    ...
    backup_required: "Резервное копирование необходимо для защиты ваших средств", // A backup is required to secure your funds
    ...
    save_wallet_to_cloud: "Сохраните свой кошелек в облаке и защитите его паролем", // Save your wallet to the cloud and protect it with a password
    write_on_paper: "Записать на бумаге", // Write on paper
    write_down_seed_phrase: "Запишите свою сид-фразу или сохраните ее в менеджере паролей", // Write down your Seed Phrase or save it in a password manager
    why_backups_important_description: "Самостоятельное хранение означает, что никто другой не может получить доступ к вашим средствам, даже команда MyDoge. Резервная копия - единственный способ восстановить ваш кошелек, если ваше устройство повреждено, потеряно или украдено, или стерто.", // Self-custody means that nobody else can access your funds, not even the MyDoge team. A backup is the only way to restore your wallet if your device is damaged, lost or stolen, or erased.
    choose_password: "Выберите пароль", // Choose a password
    use_memorable_password: "Пожалуйста, используйте пароль, который вы сможете запомнить. Более длинные пароли более безопасны.", // Please use a password you can remember. Longer passwords are more secure.
    more_secure_password: "Пожалуйста, используйте пароль, который вы сможете запомнить. Более длинные пароли более безопасны.", // Please use a password you can remember. Longer passwords are more secure.
    lose_password_lose_backup: "Если вы потеряете этот пароль, вы потеряете резервную копию кошелька.", // If you lose this password you will lose your wallet backup.
    ...
    existing_wallet_overwrite_prompt: "У вас есть существующий кошелек, ранее сохраненный в облаке. Хотите перезаписать его?", // You have an existing wallet previously backed up to the cloud. Do you want to overwrite it?
    ...
    unknown_cloud_error_body: "Произошла неизвестная ошибка при резервном копировании в облако.", // There was an unknown error while backing up to the cloud.
    try_again_or_notify_support: "Пожалуйста, попробуйте еще раз или сообщите в службу поддержки MyDoge.", // Please try again or notify MyDoge support.
    enter_recovery_password: "Введите пароль восстановления", // Enter Recovery Password
    enter_cloud_password_description: "Введите пароль, который вы использовали для хранения вашей сид-фразы в облаке", // Enter the password you used to store your seed phrase on the cloud
    ...
    save_words_order: "Сохраните эти слова по порядку. Запишите их и храните в безопасном месте или скопируйте в менеджер паролей.", // Save these words, in order. Write them down and keep them somewhere safe, or copy them to a password manager.
    seed_phrase_key: "Ваша сид-фраза - это ключ к вашему кошельку. Любой, у кого есть эта фраза, может получить доступ к вашим средствам. Нажмите, чтобы узнать больше", // Your Seed Phrase is the key to your wallet. Anyone with this phrase can access your funds. Tap to learn more
    written_down: "Я записал(а) это", // I've written it down
    screenshot_alert: "Скриншоты или другие цифровые копии вашей сид-фразы могут попасть к третьим лицам.", // Screenshots or other digital copies of your Seed Phrase could leak to a third party.
    ...
    select_correct_word: "Пожалуйста, выберите правильное слово в каждой позиции из списка ниже.", // Please select the correct word in each position from the list below.
    enter_seed_phrase: "Введите сид-фразу", // Enter Seed Phrase
    enter_seed_phrase_instructions: "Введите вашу 12-словную сид-фразу для восстановления существующего кошелька", // Enter your 12 word Seed Phrase to restore your existing wallet
    ...
    restore_existing_wallet_instructions: "У вас уже есть кошелек? Давайте восстановим его!", // So you've got a wallet already? Let's bring it back up then!
    ...
    restore_with_seed_phrase_description: "Используйте вашу сид-фразу для восстановления существующего кошелька MyDoge", // Use your seed phrase to Restore an existing MyDoge wallet
    no_cloud_backup: "Нет резервной копии в облаке", // No Cloud Backup
    no_cloud_backup_body: "Резервная копия в облаке не найдена. Пожалуйста, восстановите из сид-фразы или создайте новый кошелек", // Cloud backup not found. Please restore from a seed phrase, or create a new wallet
    ...
    send_doge_tips: "Отправляйте чаевые в Doge на 𝕏, храните свои Doge безопасно и будьте своим собственным банком", // Send Doge tips on 𝕏, store your Doge safely, and be your own bank
    shop_gift_cards_apparel: "Покупайте подарочные карты и одежду", // Shop Gift Cards and Apparel
    buy_gift_cards: "Покупайте подарочные карты за Dogecoin или приобретайте последние модели одежды с Doge", // Buy gift cards with Dogecoin, or shop the latest Doge Fashion
    enter_the_dogeverse: "Войдите в Dogeverse", // Enter the Dogeverse
    claim_dogtag: "Получите свой DogeTag, найдите друзей, получайте платежи по своей ссылке и делитесь мемами", // Claim Your DogeTag, find friends, receive payments with your link, and share memes
    ...
    transaction_confirmation_alert: "Всегда проверяйте, кому вы отправляете, перед подтверждением. Никогда не отправляйте на адрес вывода биржи. Транзакции Dogecoin нельзя отменить!", // Always double check who you are sending to before confirming. Never send to an exchange withdrawal address. Dogecoin transactions can not be reversed!
    ...
    grant_camera_permission_android: "Пожалуйста, предоставьте разрешение на использование камеры для MyDoge", // Please grant camera permission for MyDoge
    ...
    find_friends_description: "Разрешите доступ к контактам, чтобы легко находить друзей и контакты в MyDoge.", // Allow contact access and make it easy to find friends and contacts on MyDoge.
    ...
    forgot_pin_body: "Хотите использовать биометрию для разблокировки кошелька?", // Do you want to use biometrics to unlock your wallet?
    ...
    memes_error: "Ошибка при загрузке мемов. Пожалуйста, вернитесь назад и попробуйте снова.", // Error loading memes. Please go back and try again.
    user_profile_hidden: "Профиль пользователя скрыт", // User profile is hidden
    error_loading_profile: "Ошибка при загрузке профиля. Пожалуйста, вернитесь назад и попробуйте снова.", // Error loading profile. Please go back and try again.
    uid_not_specified: "Ошибка: uid не указан. Пожалуйста, сообщите в службу поддержки.", // Error: uid not specified. Please notify support.
    block_or_report_description: "MyDoge проверит все профили, на которые поступили жалобы, на предмет нарушения наших правил. Вы также можете заблокировать профиль, чтобы не видеть его посты.", // MyDoge will review all reported profiles for any activity against our guidelines. You can also block the profile to stop seeing their posts.
    ...
    unblock_user_description: "Это разблокирует пользователя, и вы снова будете видеть его посты.", // This will unblock the user and you will continue to see their posts.
    ...
    delete_backup_confirmation: "После удаления этой резервной копии вы потеряете свою облачную копию, это действие нельзя отменить", // Once you delete this backup, you lose your cloud backup, this action cannot be undone
    ...
    whatsapp_verification_notice: "Код подтверждения будет отправлен на ваш телефон через WhatsApp", // A verification code will be sent to your phone via WhatsApp
    via_whatsapp: "через WhatsApp", // via WhatsApp
    you_may_not_have_backed_up_your_wallet: "У вас есть существующая резервная копия в облаке, но возможно, вы не создали резервную копию вашего текущего кошелька.", // You have an existing backup on the cloud, but you may not have backed up your current wallet.
