...
export const fr = {
  translation: {
    ...
    you_havent_created_a_cloud_backup: "Vous n'avez pas créé de sauvegarde cloud", // You haven't created a Cloud Backup
    manage: "Gérer", // Manage
    ...
    pin_description: "Si vous oubliez votre code PIN, vous devrez restaurer votre portefeuille à partir d'une sauvegarde.", // If your forget your PIN, you will need to restore your wallet from a backup.
    change_pin: "Changer le code PIN", // Change PIN
    your_pin_is_required: "Votre code PIN est requis pour effectuer des paiements et effectuer des actions sensibles.", // Your PIN is required to make payments and perform sensitive actions.
    use_fingerprint: "Utiliser l'empreinte digitale/l'identification faciale", // Use Fingerprint/Face ID
    ask_every_time_i_open_the_app: "Demander à chaque fois que j'ouvre l'application", // Ask every time I open the app
    this_will_remove_all_wallet: "Cela supprimera toutes les données liées au portefeuille de votre appareil.", // This will remove all wallet related data from your device.
    ...
    dogeverse_intro_description: "Réclamez votre DogeTag, trouvez des amis, recevez des paiements avec votre lien et interagissez avec le contenu du Dogeverse.", // Claim Your DogeTag, find friends, receive payments with your link, and engage with content in the Dogeverse.
    sign_in: "Se connecter", // Sign in
    sign_in_description: "Votre numéro de téléphone sert uniquement à vous connecter et ne sera pas rendu public.", // Your phone number is only used to sign in and will not be made public.
    create_account_description: "Rejoignez le Dogeverse et connectez-vous à un vaste réseau de Shibes.", // Join the Dogeverse and connect with a huge network of Shibes.
    ...
    youre_now_ready_to_explore_the_dogeverse: "Vous êtes maintenant prêt à explorer le Dogeverse !", // You're now ready to explore the Dogeverse!
    ...
    show_wallet_address_and_tip_button: "Afficher l'adresse du portefeuille et le bouton Pourboire", // Show wallet address and Tip button
    ...
    send_doge_alert_box_message: "Vous pouvez envoyer DOGE à vos amis, saisir une adresse de portefeuille ou un nom d'utilisateur MyDoge", // You can send DOGE to your friends, enter a wallet address or a MyDoge username
    ...
    max_tx_size_warning: "AVERTISSEMENT : Taille maximale de la transaction atteinte. C'est le maximum que vous puissiez envoyer en une seule fois.", // WARNING: Max transaction size reached. This is the most you can send at once.
    ...
    enter_new_PIN_description: "Entrez votre nouveau code PIN pour votre portefeuille MyDoge", // Enter your new PIN for your MyDoge wallet
    enter_old_PIN: "Entrez l'ancien code PIN", // Enter old PIN
    enter_old_PIN_description: "Entrez votre ancien code PIN pour votre portefeuille MyDoge", // Enter your old PIN for your MyDoge wallet
    forgot_PIN: "Code PIN oublié", // Forgot PIN
    confirm: "Confirmer", // Confirm
    biometrics_confirmation: "Voulez-vous utiliser la biométrie pour déverrouiller votre portefeuille ?", // Do you want to use biometrics to unlock your wallet?
    use_biometrics: "Utiliser la biométrie", // Use Biometrics
    dismiss: "Rejeter", // Dismiss
    remove_wallet_data_description: " Cela supprimera toutes les données liées au portefeuille de votre appareil.", // This will remove all wallet related data from your device.
    ...
    remove_wallet_description: "Votre portefeuille actuel sera supprimé de cette application, mais il existera toujours sur la blockchain.", // Your current wallet will be removed from this app, however it will always exist on the blockchain.
    remove_profile_assets_description: "Votre profil utilisateur et vos actifs seront supprimés et supprimés définitivement. Cette action ne peut pas être annulée.", // Your user profile and assets will be removed and deleted permanently. This action cannot be undone.
    wallet_recovery_description: " Vous pouvez UNIQUEMENT récupérer ce portefeuille avec votre", // You can ONLY recover this wallet with your
    ...
    save_seed_phrase_instructions: " Gardez ces mots, dans l'ordre. Notez-les et conservez-les dans un endroit sûr, ou copiez-les dans un gestionnaire de mots de passe.", // Save these words, in order. Write them down and keep them somewhere safe, or copy them to a password manager.
    seed_phrase_warning: "Votre phrase de départ est la clé de votre portefeuille. Toute personne possédant cette phrase peut accéder à vos fonds. Appuyez pour en savoir plus", // Your Seed Phrase is the key to your wallet. Anyone with this phrase can access your funds. Tap to learn more
    copy: "Copie", // Copy
    hide: "Cacher", // Hide
    show: "Afficher", // Show
    screenshot_detected: "Capture d'écran détectée", // Screenshot detected
    screenshot_warning: "Des captures d'écran ou d'autres copies numériques de votre phrase de départ pourraient être divulguées à un tiers.", // Screenshots or other digital copies of your seed phrase could leak to a third party.
    okay: "D'accord", // Okay
    ...
    visit_mydogetv_twitch: "Visitez MyDogeTV sur Twitch pour plus d'informations", // Visit MyDogeTV on Twitch for more info
    ...
    save_wallet_to_cloud: "Enregistrez votre portefeuille dans le cloud et protégez-le avec un mot de passe", // Save your wallet to the cloud and protect it with a password
    write_on_paper: "Écrire sur papier", // Write on paper
    write_down_seed_phrase: "Notez votre phrase de départ ou enregistrez-la dans un gestionnaire de mots de passe", // Write down your Seed Phrase or save it in a password manager
    why_backups_important_description: "L'auto-garde signifie que personne d'autre ne peut accéder à vos fonds, pas même l'équipe MyDoge. Une sauvegarde est le seul moyen de restaurer votre portefeuille si votre appareil est endommagé, perdu ou volé, ou effacé.", // Self-custody means that nobody else can access your funds, not even the MyDoge team. A backup is the only way to restore your wallet if your device is damaged, lost or stolen, or erased.
    choose_password: "Choisissez un mot de passe", // Choose a password
    use_memorable_password: "Veuillez utiliser un mot de passe dont vous vous souviendrez. Les mots de passe plus longs sont plus sécurisés.", // Please use a password you can remember. Longer passwords are more secure.
    more_secure_password: "Veuillez utiliser un mot de passe dont vous vous souviendrez. Les mots de passe plus longs sont plus sécurisés.", // Please use a password you can remember. Longer passwords are more secure.
    lose_password_lose_backup: "Si vous perdez ce mot de passe, vous perdrez la sauvegarde de votre portefeuille.", // If you lose this password you will lose your wallet backup.
    ...
    existing_wallet_overwrite_prompt: "Vous avez un portefeuille existant précédemment sauvegardé dans le cloud. Voulez-vous l'écraser ?", // You have an existing wallet previously backed up to the cloud. Do you want to overwrite it?
    ...
    unknown_cloud_error_body: "Une erreur inconnue s'est produite lors de la sauvegarde dans le cloud.", // There was an unknown error while backing up to the cloud.
    try_again_or_notify_support: "Veuillez réessayer ou informer le support MyDoge.", // Please try again or notify MyDoge support.
    enter_recovery_password: "Entrez le mot de passe de récupération", // Enter Recovery Password
    enter_cloud_password_description: "Entrez le mot de passe que vous avez utilisé pour stocker votre phrase de départ sur le cloud", // Enter the password you used to store your seed phrase on the cloud
    ...
    imported_wallet_success: "Vous avez importé votre portefeuille avec succès !", // You've successfully imported your wallet!
    ...
    pin_payment_note: "Vous aurez besoin de votre code PIN pour envoyer des paiements", // You'll need your PIN to send payments
    ...
    save_words_order: "Sauvegardez ces mots, dans l'ordre. Notez-les et conservez-les dans un endroit sûr, ou copiez-les dans un gestionnaire de mots de passe.", // Save these words, in order. Write them down and keep them somewhere safe, or copy them to a password manager.
    seed_phrase_key: "Votre phrase de départ est la clé de votre portefeuille. Toute personne possédant cette phrase peut accéder à vos fonds. Appuyez pour en savoir plus", // Your Seed Phrase is the key to your wallet. Anyone with this phrase can access your funds. Tap to learn more
    written_down: "Je l'ai noté", // I've written it down
    screenshot_alert: "Les captures d'écran ou autres copies numériques de votre phrase de départ pourraient être divulguées à un tiers.", // Screenshots or other digital copies of your Seed Phrase could leak to a third party.
    ...
    select_correct_word: "Veuillez sélectionner le mot correct à chaque position dans la liste ci-dessous.", // Please select the correct word in each position from the list below.
    enter_seed_phrase: "Entrez la phrase de départ", // Enter Seed Phrase
    enter_seed_phrase_instructions: "Entrez votre phrase de départ de 12 mots pour restaurer votre portefeuille existant", // Enter your 12 word Seed Phrase to restore your existing wallet
    paste: "Coller", // Paste
    ...
    restore_existing_wallet_instructions: "Vous avez déjà un portefeuille ? Ramenons-le alors !", // So you've got a wallet already? Let's bring it back up then!
    ...
    restore_with_seed_phrase_description: "Utilisez votre phrase de départ pour restaurer un portefeuille MyDoge existant", // Use your seed phrase to Restore an existing MyDoge wallet
    no_cloud_backup: "Pas de sauvegarde cloud", // No Cloud Backup
    no_cloud_backup_body: "Sauvegarde cloud introuvable. Veuillez restaurer à partir d'une phrase de départ ou créer un nouveau portefeuille", // Cloud backup not found. Please restore from a seed phrase, or create a new wallet
    ...
    send_doge_tips: "Envoyez des pourboires Doge sur 𝕏, stockez vos Doge en toute sécurité et soyez votre propre banque", // Send Doge tips on 𝕏, store your Doge safely, and be your own bank
    shop_gift_cards_apparel: "Achetez des cartes-cadeaux et des vêtements", // Shop Gift Cards and Apparel
    buy_gift_cards: "Achetez des cartes-cadeaux avec du Dogecoin, ou achetez les derniers articles de mode Doge", // Buy gift cards with Dogecoin, or shop the latest Doge Fashion
    enter_the_dogeverse: "Entrez dans le Dogeverse", // Enter the Dogeverse
    claim_dogtag: "Réclamez votre DogeTag, trouvez des amis, recevez des paiements avec votre lien et partagez des mèmes", // Claim Your DogeTag, find friends, receive payments with your link, and share memes
    ...
    get_notifications_for_tips: "Recevez des notifications pour les pourboires et les messages", // Get notifications for Tips and Messages
    ...
    transaction_confirmation_alert: "Vérifiez toujours à qui vous envoyez avant de confirmer. N'envoyez jamais à une adresse de retrait d'échange. Les transactions Dogecoin ne peuvent pas être annulées !", // Always double check who you are sending to before confirming. Never send to an exchange withdrawal address. Dogecoin transactions can not be reversed!
    ...
    grant_camera_permission_android: "Veuillez accorder la permission de la caméra à MyDoge", // Please grant camera permission to MyDoge
    ...
    find_friends_description: "Autorisez l'accès aux contacts et facilitez la recherche d'amis et de contacts sur MyDoge.", // Allow contact access and make it easy to find friends and contacts on MyDoge.
    ...
    enter_pin_to_confirm: "Entrez votre code PIN de portefeuille pour confirmer", // Enter your Wallet Pin to confirm
    ...
    forgot_pin_body: "Voulez-vous utiliser la biométrie pour déverrouiller votre portefeuille ?", // Do you want to use biometrics to unlock your wallet?
    ...
    memes_error: "Erreur lors du chargement des mèmes. Veuillez revenir en arrière et réessayer.", // Error loading memes. Please go back and try again.
    user_profile_hidden: "Le profil utilisateur est masqué", // User profile is hidden
    error_loading_profile: "Erreur de chargement du profil. Veuillez revenir en arrière et réessayer.", // Error loading profile. Please go back and try again.
    uid_not_specified: "Erreur : UID non spécifié. Veuillez en informer le support.", // Error: uid not specified. Please notify support.
    block_or_report_description: "MyDoge examinera tous les profils signalés pour toute activité contraire à nos directives. Vous pouvez également bloquer le profil pour ne plus voir leurs publications.", // MyDoge will review all reported profiles for any activity against our guidelines. You can also block the profile to stop seeing their posts.
    nevermind: "Pas grave", // Nevermind
    report: "Rapport", // Report
    block: "Bloc", // Block
    unblock_user: "Débloquer l'utilisateur?", // Unblock User?
    unblock_user_description: "Cela débloquera l'utilisateur et vous continuerez à voir ses publications.", // This will unblock the user and you will continue to see their posts.
    ...
    delete_backup_confirmation: "Une fois que vous supprimez cette sauvegarde, vous perdez votre sauvegarde cloud, cette action ne peut pas être annulée", // Once you delete this backup, you lose your cloud backup, this action cannot be undone
    ...
    whatsapp_verification_notice: "Un code de vérification sera envoyé à votre téléphone via WhatsApp", // A verification code will be sent to your phone via WhatsApp
    via_whatsapp: "via WhatsApp", // via WhatsApp
    you_may_not_have_backed_up_your_wallet: "Vous avez une sauvegarde existante dans le cloud, mais vous n'avez peut-être pas sauvegardé votre portefeuille actuel.", // You have an existing backup on the cloud, but you may not have backed up your current wallet.
