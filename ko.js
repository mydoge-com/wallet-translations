...
export const ko = {
  translation: {
    ...
    back_up_your_wallet_description: "지갑을 클라우드에 저장하고 비밀번호로 보호하세요. 또한 시드 복구 구문를 적어두거나 비밀번호 관리자에 복사할 수도 있습니다.", // Save your wallet to the cloud and protect it with a password. You can also write down your Seed Phrase or copy it to a password manager.
    pin_description: "PIN 암호를 잊어버린 경우 백업에서 지갑을 복원해야 합니다.", // If your forget your PIN, you will need to restore your wallet from a backup.
    change_pin: "PIN 암호 변경", // Change PIN
    your_pin_is_required: "결제하고 민감한 작업을 수행하려면 PIN 암호가 필요합니다.", // Your PIN is required to make payments and perform sensitive actions.
    ...
    this_will_remove_all_wallet: "이렇게 하면 기기에서 지갑 관련 데이터가 모두 삭제됩니다.", // This will remove all wallet related data from your device.
    delete_wallet: "지갑 삭제", // Delete Wallet
    sign_in_to_the_dogeverse: "Dogeverse에 로그인하세요", // Sign in to the Dogeverse
    dogeverse_intro_description: "DogeTag를 요청하고, 친구를 찾고, 링크로 결제를 받고, Dogeverse의 콘텐츠에 참여하세요.", // Claim Your DogeTag, find friends, receive payments with your link, and engage with content in the Dogeverse.
    sign_in: "로그인", // Sign in
    sign_in_description: "귀하의 전화번호는 로그인에만 사용되며 공개되지 않습니다.", // Your phone number is only used to sign in and will not be made public.
    create_account_description: "Dogeverse에 가입하고 Shibes의 거대한 네트워크에 연결하세요.", // Join the Dogeverse and connect with a huge network of Shibes.
    ...
    youre_now_ready_to_explore_the_dogeverse: "이제 Dogeverse를 탐험할 준비가 되었습니다!", // You're now ready to explore the Dogeverse!
    ...
    send_doge_alert_box_message: "DOGE를 친구에게 보내거나 지갑 주소 또는 MyDoge 사용자 이름을 입력할 수 있습니다.", // You can send DOGE to your friends, enter a wallet address or a MyDoge username
    ...
    max_tx_size_warning: "경고: 최대 트랜잭션 크기에 도달했습니다. 한 번에 보낼 수 있는 최대 한도입니다.", // WARNING: Max transaction size reached. This is the most you can send at once.
    confirm_transaction_warning: "확인하기 전에 항상 누구에게 보내는지 다시 확인하세요. 절대 거래소 출금 주소로 보내지 마세요. Dogecoin 거래는 되돌릴 수 없습니다!", // Always double check who you are sending to before confirming. Never send to an exchange withdrawal address. Dogecoin transactions can not be reversed!
    ...
    confirm: "확인", // Confirm
    biometrics_confirmation: "생체 인식을 사용하여 지갑을 잠금 해제하시겠습니까?", // Do you want to use biometrics to unlock your wallet?
    use_biometrics: "생체 인식 사용", // Use Biometrics
    dismiss: "닫기", // Dismiss
    remove_wallet_data_description: " 이렇게 하면 기기에서 지갑 관련 데이터가 모두 삭제됩니다.", // This will remove all wallet related data from your device.
    ...
    remove_wallet_description: "현재 지갑은 이 앱에서 제거되지만 블록체인에는 항상 존재합니다.", // Your current wallet will be removed from this app, however it will always exist on the blockchain.
    remove_profile_assets_description: "귀하의 사용자 프로필과 자산이 제거되고 영구적으로 삭제됩니다. 이 작업은 취소할 수 없습니다.", // Your user profile and assets will be removed and deleted permanently. This action cannot be undone.
    wallet_recovery_description: " 귀하는 귀하의 지갑으로만 이 지갑을 복구할 수 있습니다.", // You can ONLY recover this wallet with your
    ...
    save_seed_phrase_instructions: " 이 단어들을 순서대로 저장하세요. 적어서 안전한 곳에 보관하거나 비밀번호 관리자에 복사하세요.", // Save these words, in order. Write them down and keep them somewhere safe, or copy them to a password manager.
    seed_phrase_warning: "귀하의 시드 복구 구문은 지갑의 열쇠입니다. 이 문구를 아는 사람은 누구나 귀하의 자금에 접근할 수 있습니다. 자세히 알아보려면 탭하세요.", // Your Seed Phrase is the key to your wallet. Anyone with this phrase can access your funds. Tap to learn more
    copy: "복사", // Copy
    hide: "숨기기", // Hide
    show: "보여주기", // Show
    screenshot_detected: "스크린샷이 감지되었습니다.", // Screenshot detected
    screenshot_warning: "시드 복구 구문의 스크린샷이나 기타 디지털 사본이 제3자에게 유출될 수 있습니다.", // Screenshots or other digital copies of your seed phrase could leak to a third party.
    okay: "좋아요", // Okay
    ...
    write_down_seed_phrase: "시드 복구 구문를 적어두거나 비밀번호 관리자에 저장하세요", // Write down your Seed Phrase or save it in a password manager
    why_backups_important_description: "자기 관리권은 MyDoge 팀을 포함하여 누구도 귀하의 자금에 접근할 수 없음을 의미합니다. 백업은 장치가 손상되거나 분실 또는 도난당하거나 지워진 경우 지갑을 복원할 수 있는 유일한 방법입니다.", // Self-custody means that nobody else can access your funds, not even the MyDoge team. A backup is the only way to restore your wallet if your device is damaged, lost or stolen, or erased.
    choose_password: "비밀번호를 선택하세요", // Choose a password
    use_memorable_password: "기억할 수 있는 비밀번호를 사용해주세요. 비밀번호가 길수록 더 안전합니다.", // Please use a password you can remember. Longer passwords are more secure.
    more_secure_password: "기억할 수 있는 비밀번호를 사용해주세요. 비밀번호가 길수록 더 안전합니다.", // Please use a password you can remember. Longer passwords are more secure.
    ...
    existing_wallet_overwrite_prompt: "이전에 클라우드에 백업된 기존 지갑이 있습니다. 덮어쓰시겠습니까?", // You have an existing wallet previously backed up to the cloud. Do you want to overwrite it?
    ...
    unknown_cloud_error_body: "클라우드에 백업하는 중에 알 수 없는 오류가 발생했습니다.", // There was an unknown error while backing up to the cloud.
    try_again_or_notify_support: "다시 시도하거나 MyDoge 지원팀에 알려주십시오.", // Please try again or notify MyDoge support.
    enter_recovery_password: "복구 비밀번호를 입력하세요", // Enter Recovery Password
    enter_cloud_password_description: "클라우드에 시드 복구 구문를 저장하는 데 사용한 비밀번호를 입력하세요", // Enter the password you used to store your seed phrase on the cloud
    ...
    save_words_order: "이 단어들을 순서대로 저장하세요. 적어서 안전한 곳에 보관하거나 비밀번호 관리자에 복사하세요.", // Save these words, in order. Write them down and keep them somewhere safe, or copy them to a password manager.
    seed_phrase_key: "귀하의 시드 복구 구문는 지갑의 열쇠입니다. 이 문구를 아는 사람은 누구나 귀하의 자금에 접근할 수 있습니다. 자세히 알아보려면 탭하세요.", // Your Seed Phrase is the key to your wallet. Anyone with this phrase can access your funds. Tap to learn more
    written_down: "적어놨어요", // I've written it down
    screenshot_alert: "귀하의 Seed Phrase의 스크린샷이나 기타 디지털 사본이 제3자에게 유출될 수 있습니다.", // Screenshots or other digital copies of your Seed Phrase could leak to a third party.
    seed_phrase_access: " 귀하의 시드 복구 구문를 아는 사람은 누구나 귀하의 자금에 접근할 수 있습니다. 귀하의 시드 복구 구문를 누구와도 공유하지 마십시오. MyDoge는 귀하의 시드 복구 구문를 저장하지 않습니다. 귀하의 장치가 손상되거나, 분실 또는 도난당하거나, 기타 접근이 불가능할 경우, 귀하의 시드 복구 구문가 귀하의 지갑을 복구할 수 있는 유일한 방법입니다.", // Anyone with your Seed Phrase can access your funds. Do not share your Seed Phrase with anyone. MyDoge does not save your Seed Phrase for you. Should your device be damaged, lost or stolen, or otherwise inaccessible, your Seed Phrase is the only way to recover your wallet.
    ...
    enter_seed_phrase_instructions: "기존 지갑을 복원하려면 12단어 시드 복구 구문를 입력하세요.", // Enter your 12 word Seed Phrase to restore your existing wallet
    paste: "붙여넣기", // Paste
    ...
    restore_existing_wallet_instructions: " 그럼 지갑은 이미 갖고 계시나요? 그럼 다시 가져오기!", // So you've got a wallet already? Let's bring it back up then!
    ...
    restore_with_seed_phrase_description: "시드 복구 구문를 사용하여 기존 MyDoge 지갑을 복원하세요.", // Use your seed phrase to Restore an existing MyDoge wallet
    no_cloud_backup: "클라우드 백업 없음", // No Cloud Backup
    no_cloud_backup_body: "클라우드 백업을 찾을 수 없습니다. 시드 복구 구문에서 복원하거나 새 지갑을 생성하세요", // Cloud backup not found. Please restore from a seed phrase, or create a new wallet
    ...
    send_doge_tips: "𝕏에서 Doge 팁을 보내고 Doge를 안전하게 보관하고 나만의 은행이 되세요", // Send Doge tips on 𝕏, store your Doge safely, and be your own bank
    shop_gift_cards_apparel: "기프트 카드 및 의류 쇼핑", // Shop Gift Cards and Apparel
    buy_gift_cards: "Dogecoin으로 기프트 카드를 구매하거나 최신 Doge Fashion을 쇼핑하세요.", // Buy gift cards with Dogecoin, or shop the latest Doge Fashion
    enter_the_dogeverse: "Dogeverse에 들어가세요", // Enter the Dogeverse
    claim_dogtag: "DogeTag를 요청하고, 친구를 찾고, 링크로 결제를 받고, 밈을 공유하세요", // Claim Your DogeTag, find friends, receive payments with your link, and share memes
    ...
    transaction_confirmation_alert: "확인하기 전에 항상 누구에게 보내는지 다시 확인하세요. 절대 거래소 출금 주소로 보내지 마세요. Dogecoin 거래는 되돌릴 수 없습니다!", // Always double check who you are sending to before confirming. Never send to an exchange withdrawal address. Dogecoin transactions can not be reversed!
    ...
    find_friends_description: "연락처 액세스를 허용하고 MyDoge에서 친구와 연락처를 쉽게 찾을 수 있도록 하세요.", // Allow contact access and make it easy to find friends and contacts on MyDoge.
    ...
    memes_error: "밈을 로드하는 중에 오류가 발생했습니다. 돌아가서 다시 시도해 주세요.", // Error loading memes. Please go back and try again.
    user_profile_hidden: "사용자 프로필이 숨겨져 있습니다.", // User profile is hidden
    error_loading_profile: "프로필을 로드하는 중에 오류가 발생했습니다. 돌아가서 다시 시도해 주세요.", // Error loading profile. Please go back and try again.
    uid_not_specified: "오류: uid가 지정되지 않았습니다. 지원팀에 알려주세요.", // Error: uid not specified. Please notify support.
    block_or_report_description: "MyDoge는 당사 지침에 반하는 모든 활동에 대해 보고된 모든 프로필을 검토합니다. 프로필을 차단하여 해당 게시물을 더 이상 볼 수도 없습니다.", // MyDoge will review all reported profiles for any activity against our guidelines. You can also block the profile to stop seeing their posts.
    nevermind: "괜찮아요", // Nevermind
    report: "보고서", // Report
    block: "차단하다", // Block
    unblock_user: "사용자 차단을 해제하시겠습니까?", // Unblock User?
    unblock_user_description: "이렇게 하면 해당 사용자의 차단이 해제되고 해당 사용자의 게시물을 계속 볼 수 있습니다.", // This will unblock the user and you will continue to see their posts.
    ...
    delete_backup_confirmation: "이 백업을 삭제하면 클라우드 백업이 손실되며 이 작업은 취소할 수 없습니다.", // Once you delete this backup, you lose your cloud backup, this action cannot be undone
