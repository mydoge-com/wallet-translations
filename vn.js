export const vn = {
    translation: {
        ...
        existing_wallet_overwrite_prompt: 'Bạn có một ví trước đây đã được sao lưu lên đám mây. Bạn có muốn ghi đè nó không?',
        ...
        save_words_order: 'Lưu các từ này theo thứ tự. Ghi lại Cụm từ khôi phục và giữ ở chỗ an toàn, hoặc lưu vào trình quản lý mật khẩu.',
        seed_phrase_key: 'Cụm từ khôi phục là chìa khóa ví của bạn. Bất cứ ai có được cụm từ này đều có thể truy cập vào tài sản của bạn. Nhấn để tìm hiểu thêm',
        written_down: 'Tôi đã ghi lại',
        screenshot_alert: 'Chụp ảnh màn hình hoặc lưu trữ kỹ thuật số Cụm từ khôi phục có thể rò rỉ cho bên thứ ba.',
        seed_phrase_access: 'Bất cứ ai có Cụm từ khôi phục đều có thể truy cập vào tài sản của bạn. Không chia sẻ Cụm từ khôi phục với bất kỳ ai. MyDoge không lưu trữ Cụm từ khôi phục của bạn. Nếu thiết bị của bạn bị hỏng, bị đánh cắp hoặc không thể truy cập thì Cụm từ khôi phục là cách duy nhất để khôi phục ví của bạn.',
