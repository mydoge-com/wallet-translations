export const vn = {
    translation: {
        ...
        seed_phrase_warning: 'Cụm từ khôi phục là chìa khóa ví của bạn. Bất cứ ai có được cụm từ này đều có thể truy cập vào tài sản của bạn. Nhấn để tìm hiểu thêm',
        copy: 'Sao chép',
        hide: 'Ẩn',
        show: 'Hiện',
        screenshot_detected: 'Phát hiện chụp ảnh màn hình',
        screenshot_warning: 'Chụp ảnh màn hình hoặc lưu trữ kỹ thuật số của Cụm từ khôi phục có thể rò rỉ cho bên thứ ba.',
        okay: 'Đồng ý',
        seed_phrase_importance: 'Cụm từ khôi phục của tôi quan trọng như thế nào?',
        seed_phrase_explanation: 'Bất cứ ai có Cụm từ khôi phục của bạn đều có thể truy cập vào tài sản của bạn. Không chia sẻ Cụm từ khôi phục với bất kỳ ai. MyDoge không lưu trữ Cụm từ khôi phục của bạn. Nếu thiết bị của bạn bị hỏng, mất mát hoặc bị đánh cắp, hoặc không thể truy cập, Cụm từ khôi phục là cách duy nhất để khôi phục ví của bạn.',
        ...
        write_down_seed_phrase: 'Ghi lại cụm từ khôi phục của bạn hoặc lưu nó trong trình quản lý mật khẩu.',
        ...
        use_memorable_password: 'Vui lòng sử dụng mật khẩu bạn có thể nhớ. Mật khẩu dài hơn sẽ an toàn hơn.',
        more_secure_password: 'Vui lòng sử dụng mật khẩu bạn có thể nhớ. Mật khẩu dài hơn sẽ an toàn hơn.',
        ...
        enter_cloud_password_description: 'Nhập mật khẩu bạn đã sử dụng để lưu trữ Cụm từ khôi phục của bạn trên đám mây',
        ...
        seed_phrase_key: 'Cụm từ khôi phục của bạn là chìa khóa của ví của bạn. Bất cứ ai có được cụm từ này đều có thể truy cập vào tài sản của bạn. Nhấn để tìm hiểu thêm',
        written_down: 'Tôi đã ghi lại',
        screenshot_alert: 'Chụp ảnh màn hình hoặc lưu trữ kỹ thuật số của Cụm từ khôi phục có thể rò rỉ cho bên thứ ba.',
        seed_phrase_access: 'Bất cứ ai có Cụm từ khôi phục của bạn đều có thể truy cập vào tài sản của bạn. Không chia sẻ Cụm từ khôi phục với bất kỳ ai. MyDoge không lưu trữ Cụm từ khôi phục của bạn. Nếu thiết bị của bạn bị hỏng, mất mát hoặc bị đánh cắp, hoặc không thể truy cập, Cụm từ khôi phục là cách duy nhất để khôi phục ví của bạn.',
        ...
        enter_seed_phrase_instructions: 'Nhập 12 từ Cụm từ khôi phục theo thứ tự để xác nhận.',
        incorrect_seed_phrase: 'Cụm từ khôi phục không chính xác. Vui lòng thử lại.',
        confirm_backup_phrase: 'Xác nhận Cụm từ khôi phục của bạn',
        confirm_backup_instructions: 'Vui lòng nhập lại Cụm từ khôi phục của bạn để xác nhận.',
        ...
        restore_with_seed_phrase_description: 'Sử dụng Cụm từ khôi phục của bạn để khôi phục một ví MyDoge hiện có',
        no_cloud_backup: 'Không có Sao lưu đám mây',
        no_cloud_backup_body: 'Không tìm thấy sao lưu đám mây. Vui lòng khôi phục từ Cụm từ khôi phục, hoặc tạo một ví mới',
        create_wallet: 'Tạo một ví',
        already_have_wallet: 'Tôi đã có một ví',
        buy_send_receive_dogecoin: 'Mua, Gửi & Nhận Dogecoin',
        send_doge_tips: 'Gửi gợi ý về Doge trên 𝕏, lưu trữ Doge của bạn một cách an toàn, và trở thành ngân hàng của chính bạn.',
        ...
        transaction_confirmation_alert: 'Luôn kiểm tra kỹ trước khi xác nhận gửi đi. Không bao giờ gửi vào địa chỉ rút tiền từ sàn giao dịch. Các giao dịch Dogecoin không thể đảo ngược!',
